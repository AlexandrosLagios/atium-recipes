...
- Method steps are whole sentences in order. A method step obeys every quantity rule above, so never copy a measure out of the source unconverted: "Heat oven to 425°F" becomes "Heat the oven to 220°C".
